...
top_face_idx = max(range(len(mesh.polygons)), key=lambda i: mesh.vertices[mesh.polygons[i].vertices[0]].co.z)
...
target = Vector((1, 1, 1))  # For example, rotate to the X-axis
